    ...
    >
      ...
      <div className="relative z-10">
        ...
        <AutoPickModal
          ...
          autoTimeWindow={autoPickLogic.autoTimeWindow}
          setAutoTimeWindow={autoPickLogic.setAutoTimeWindow}
          autoDiversify={autoPickLogic.autoDiversify}
          setAutoDiversify={autoPickLogic.setAutoDiversify}
          autoBlacklist={autoPickLogic.autoBlacklist}
          setAutoBlacklist={autoPickLogic.setAutoBlacklist}
          autoTargetMode={autoPickLogic.autoTargetMode}
          setAutoTargetMode={autoPickLogic.setAutoTargetMode}
          autoTargetOdds={autoPickLogic.autoTargetOdds}
          setAutoTargetOdds={autoPickLogic.setAutoTargetOdds}
          autoGeneratedTitle={autoPickLogic.autoGeneratedTitle}
          autoStreak={autoPickLogic.autoStreak}
          setAutoStreak={autoPickLogic.setAutoStreak}
          autoExcludeCups={autoPickLogic.autoExcludeCups}
          setAutoExcludeCups={autoPickLogic.setAutoExcludeCups}
        />
