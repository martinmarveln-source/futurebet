      ...
      >
        ...
        <div className="p-4 space-y-5 overflow-y-auto flex-1 custom-scrollbar">
          ...
          <div>
            ...
            <div className="mt-6">
              <SectionHeader title="Smart Exclusions" darkMode={darkMode} />
              <div className="grid grid-cols-2 gap-2 mt-2">
                <SelectableButton
                  active={autoExcludeCups}
                  darkMode={darkMode}
                  theme="blue"
                  onClick={() => setAutoExcludeCups(!autoExcludeCups)}
                >
                  Exclude Cups & Derbies
                </SelectableButton>
                <SelectableButton
                  active={autoStreak}
                  darkMode={darkMode}
                  theme="blue"
                  onClick={() => setAutoStreak(!autoStreak)}
                >
                  Require Hot Streak
                </SelectableButton>
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              ...
              <SelectableButton
                active={autoTargetMode === "odds_builder"}
                darkMode={darkMode}
                theme="amber"
                onClick={() => setAutoTargetMode("odds_builder")}
              >
                Target Builder
              </SelectableButton>
              <SelectableButton
            ...
            {autoTargetMode === "count" ? (
              ...
              <div className="mt-4">
                <SectionHeader
                  title={`${autoTargetMode === 'odds_builder' ? 'Perfect ' : ''}Target Odds:
 ${autoTargetOdds.toFixed(2)}+`}
                  darkMode={darkMode}
                />
                <input
                  type="range"
