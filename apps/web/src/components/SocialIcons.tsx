...
export const FacebookIcon = ({ size = 16, className = "" }: { size?: number | string, className?: string }) => (
...
export const YoutubeIcon = ({ size = 16, className = "" }: { size?: number | string, className?: string }) => (
